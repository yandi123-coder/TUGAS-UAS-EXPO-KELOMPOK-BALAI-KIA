...
<main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            <a href="<?= base_url('daftar-produk/tambah2') ?>" class="btn btn-primary btn-sm mb-2" >
                            ...
                            <?php if(session('success')) : ?>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php $no = 1; ?>
                                        <?php foreach ($daftar_produk1 as $produk) : ?>
                                            <tr>
                                                <td><?= $no++; ?></td>
                                ...
                                <!-- modal Hapus -->
                                <?php foreach ($daftar_produk1 as $kategori): ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url('daftar-kategori/hapus5/'. $kategori->id_produk) ?>" method="post">
            <?= csrf_field() ?>
