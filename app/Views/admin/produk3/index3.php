...
<main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            <a href="<?= base_url('daftar-produk/tambah3') ?>" class="btn btn-primary btn-sm mb-2" >
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url('daftar-kategori/hapus7/'. $kategori->id_produk) ?>" method="post">
            <?= csrf_field() ?>
