...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('asset-admin') ?>/css/location3.css">
...
<body>
    ...
    <div class="banner">
        <video src="<?php echo base_url('asset-admin') ?>/image/pinang 2.mp4" type="video/mp4" autoplay muted loop></video>
        ...
        <nav>
            ...
            <hr />
            <a href="<?= base_url('admin/Location2Controller/locat1') ?>">
                <div class="oval1"></div>
            </a>

            <a href="<?= base_url('admin/Location2Controller/locat2'); ?>">
            <div class="oval2"></div>
            </a>

            <a href="<?= base_url('admin/Location2Controller/locat3'); ?>">
            <div class="oval3"></div>
            </a>

            <a href="<?= base_url('admin/Location2Controller/locat4'); ?>">
            <div class="oval4"></div>
            </a>
    ...
    <div class="divi">
        <h1 class="take">Take of Tour of pinang With Us</h1>
        <p class="para">Tanjung Pinang is a captivating tourist destination that boasts a rich history and vibrant local markets, making it an excellent 
        place to experience the culture of the Riau Archipelago.
        </p>
    </div>
        <hr class="hr1">
        <hr class="hr2">
    ...
    <div class="im">
        <h1 class="ims">Gallery Of Pinang best trip</h1>
                ...
                <div class="row">
                    ...
                    <div class="filter-gal-par">
                        <div class="gallery-item filter diving">
                            <img src="<?php echo base_url(relativePath: 'asset-admin') ?>/pinang/pinang1.jpg" alt=""
                                class="img-responsive">
                        </div>
                        <div class="gallery-item filter diving">
                            <img src="<?php echo base_url(relativePath: 'asset-admin') ?>/pinang/pinang2.jpg" alt=""
                                class="img-responsive">
                        </div>
                        <div class="gallery-item filter diving">
                            <img src="<?php echo base_url(relativePath: 'asset-admin') ?>/pinang/pinang3.jpg" alt=""
                                class="img-responsive">
                        </div>
                        <div class="gallery-item filter health">
                            <img src="<?php echo base_url(relativePath: 'asset-admin') ?>/pinang/pinang4.jpg" alt=""
                                class="img-responsive">
                        </div>
                        <div class="gallery-item filter health">
                            <img src="<?php echo base_url(relativePath: 'asset-admin') ?>/pinang/pinang5.jpg" alt=""
                                class="img-responsive">
                        </div>
                        <div class="gallery-item filter nature">
                            <img src="<?php echo base_url(relativePath: 'asset-admin') ?>/pinang/pinang6.jpg" alt=""
                                class="img-responsive">
                        </div>
                        <div class="gallery-item filter nature">
                            <img src="<?php echo base_url(relativePath: 'asset-admin') ?>/pinang/pinang7.jpg" alt=""
                                class="img-responsive">
                        </div>
                        <div class="gallery-item filter nature">
                            <img src="<?php echo base_url(relativePath: 'asset-admin') ?>/Batam/karimun5.jpg" alt=""
                                class="img-responsive">
                        </div>
                    </div>
                </div>
