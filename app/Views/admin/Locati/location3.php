...
<body>
        ...
        <nav>
            ...
            <ul class="navbar">
                <li>
                    ...
                    <a href="<?= base_url('Admin/PackageController/package') ?>">Package
    ...
    <div class="divi">
        <h1 class="take">Take of Tour of Batam With Us</h1>
        <p class="para">Batam is a beautiful tourist destination known for its stunning beaches, 
            vibrant nightlife, and delicious seafood, making it a perfect 
            getaway for both relaxation and adventure.
        </p>
    </div>
        <hr class="hr1">
        <hr class="hr2">
    ...
    <div class="im">
        <h1 class="ims">Gallery Of Batam best trip</h1>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="filter-gal-par">
                        ...
                        <div class="gallery-item filter nature">
                            <img src="<?php echo base_url(relativePath: 'asset-admin') ?>/asset-admin/batam/batam5.webp" alt=""
                                class="img-responsive">
                        </div>
                        <div class="gallery-item filter nature">
                            <img src="<?php echo base_url(relativePath: 'asset-admin') ?>/asset-admin/batam/batam8.jpg" alt=""
                                class="img-responsive">
                        </div>
                    </div>
                </div>
